import { Component, OnInit, OnChanges, OnDestroy, Input, Output, EventEmitter, ChangeDetectorRef, LOCALE_ID, Inject, TemplateRef } from '@angular/core';
...
export class DashboardComponent implements OnInit, OnInit, OnDestroy, OnChanges {
